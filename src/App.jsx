        ...
        <div className="p-4 sm:p-7">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              <a className="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium cursor-pointer">
                Sign up here
              </a>
            </p>
          </div>
            ...
            <form>
              <div className="grid gap-y-4">
                ...
                <div>
                  ...
                  <p className="hidden text-xs text-red-600 mt-2" id="email-error">Please include a valid email address</p>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap justify-between items-center gap-2">
                    ...
                    <a className="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="#">Forgot password?</a>
                  </div>
                  <div className="relative">
                    <input 
                      type="password" 
                ...
                <div className="flex items-center">
                  ...
                  <div className="ms-3">
                    <label htmlFor="remember-me" className="text-sm text-gray-800">Remember me</label>
                  </div>
                </div>
